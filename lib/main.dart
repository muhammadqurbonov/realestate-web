    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSeed(seedColor: _kPrimary, primary: _kPrimary, surface: _kSurface),
          ...
          appBarTheme: AppBarTheme(
            ...
            elevation: 0,
            centerTitle: false,
            titleTextStyle: GoogleFonts.manrope(fontSize: 20, fontWeight: FontWeight.w700, color: _kPrimaryDark),
          ),
